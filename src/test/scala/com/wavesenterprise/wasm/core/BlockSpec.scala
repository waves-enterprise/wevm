...
class BlockSpec extends AnyFreeSpec with Matchers {
  ...
  "get_block_timestamp" in {
    ...
    executor.runContract(contractId, bytecode, "get_block_timestamp", Array[Byte](), service) shouldBe 0
  ...
  "get_block_height" in {
    ...
    executor.runContract(contractId, bytecode, "get_block_height", Array[Byte](), service) shouldBe 0
